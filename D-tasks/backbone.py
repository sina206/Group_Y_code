...
def _mobilenet_v3_conf(
    arch, width_mult=1.0, reduced_tail=False, dilated=False, **kwargs
):
...
def new_backbone():
    ...
    conf = "mobilenet_v3_small"
    weights = load_state_dict_from_url(weights_url)
    inverted_residual_setting, last_channel = _mobilenet_v3_conf("%s" % conf)
    f = _mobilenet_v3(inverted_residual_setting, last_channel, None, False)
